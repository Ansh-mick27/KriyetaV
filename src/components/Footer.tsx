        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
          ...
          <div className="w-full md:w-1/3">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-slate-600">
                ...
                <a href="mailto:kriyeta@acropolis.in" className="hover:text-slate-900 transition-colors">kriyeta@acropolis.in</a>
              </li>
              <li className="flex items-center gap-3 text-slate-600">
                <Mail className="w-5 h-5 text-[#00e5ff] shrink-0" />
                <a href="mailto:hodaiml@acropolis.in" className="hover:text-slate-900 transition-colors">hodaiml@acropolis.in</a>
              </li>
            </ul>
          </div>
          ...
          <div className="w-full md:w-1/3">
            ...
            <ul className="space-y-3">
              <li><a href="#about" className="text-slate-600 hover:text-[#00e5ff] transition-colors">About</a></li>
              <li><a href="#tracks" className="text-slate-600 hover:text-[#00e5ff] transition-colors">Tracks</a></li>
              <li><a href="#rules" className="text-slate-600 hover:text-[#00e5ff] transition-colors">Rules & Eligibility</a></li>
              <li><a href="#sponsors" className="text-slate-600 hover:text-[#00e5ff] transition-colors">Partners</a></li>
            </ul>
          </div>
        </div>
