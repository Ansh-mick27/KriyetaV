  ...
  return (
    <BackgroundBeamsWithCollision className="min-h-screen pt-20">
      <div className="relative z-20 flex flex-col items-center justify-center w-full px-4 text-center">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white font-sans tracking-tighter mb-6 relative">
        ...
        <p className="max-w-3xl mx-auto text-xl md:text-2xl text-slate-300 font-medium mb-8 leading-relaxed">
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center mb-16">
          <span className="px-6 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 font-medium backdrop-blur-sm">
            Discover
          </span>
          <span className="px-6 py-2 rounded-full bg-white/5 border border-white/10 text-white/80 font-medium backdrop-blur-sm">
            Innovate
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <button className="px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold rounded-xl backdrop-blur-sm transition-all duration-300">
            View Tracks
          </button>
        </div>
      </div>
